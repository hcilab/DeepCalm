...
public class Controller_Prefab_Target : MonoBehaviour {
	...
	*/
	...
	public GameObject Spawn_New_Target(){
		...
		new_target.GetComponent<Controller_Prefab_Target> ().tex_in = parent_target.GetComponent<Controller_Prefab_Target>().tex_in;
